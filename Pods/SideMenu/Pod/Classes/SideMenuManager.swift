...
open class SideMenuManager : NSObject {
    ...
    open static var menuShadowOpacity: Float = 0
    ...
    open static var menuShadowColor = UIColor.clear
    ...
    open static var menuShadowRadius: CGFloat = 0
    ...
    open static var menuEnableSwipeGestures: Bool = false
    ...
    open static var menuAllowSubmenus: Bool = true
