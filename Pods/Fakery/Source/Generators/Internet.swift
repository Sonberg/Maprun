...
public final class Internet: Generator {
  ...
  public func username(_ separator: String? = nil) -> String {
  ...
  public func domainWord(_ alphaNumericOnly: Bool = true) -> String {
  ...
  public func password(_ minimumLength: Int = 8, maximumLength: Int = 16) -> String {
  ...
  public func image(_ width: Int = 320, height: Int = 200) -> String {
    return "http://lorempixel.com/\(width)/\(height)"
  }

  public func templateImage(_ width: Int = 320, height: Int = 200,
